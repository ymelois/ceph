...
class RbdNamespaceControllerTest(ControllerTestCase):
    ...
    def setUp(self):
        ...
        # rbd is globally mocked in UNITTEST mode; set the quota field
        # constants so the controller can build the bitmask.
        rbd.RBD_NAMESPACE_QUOTA_FIELD_MAX_BYTES = 1
        rbd.RBD_NAMESPACE_QUOTA_FIELD_MAX_OBJECTS = 2
    ...
    def test_set_quota_both(self):
        ...
        self.mock_rbd_inst.namespace_set_quota.assert_called_with(
            self.mock_ioctx, 'ns1', 3, 1073741824, 1000)
    ...
    def test_set_quota_bytes_only(self):
        ...
        self.assertStatus(200)
        self.mock_rbd_inst.namespace_set_quota.assert_called_with(
            self.mock_ioctx, 'ns1', 1, 1073741824, 0)
